...
class UserTypeTableMap extends TableMap
{
     ...
     */
    const COL_CREATED_DATE = 'user_type.created_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CreatedDate', ),
        self::TYPE_CAMELNAME     => array('id', 'createdDate', ),
        self::TYPE_COLNAME       => array(UserTypeTableMap::COL_ID, UserTypeTableMap::COL_CREATED_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'created_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CreatedDate' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'createdDate' => 1, ),
        self::TYPE_COLNAME       => array(UserTypeTableMap::COL_ID => 0, UserTypeTableMap::COL_CREATED_DATE => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'created_date' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTypeTableMap::COL_CREATED_DATE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \UserType) { // it's a model_propel object
