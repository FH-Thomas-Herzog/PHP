 ...
 * @method     ChildUserQuery orderByUpdatedDate($order = Criteria::ASC) Order by the updated_date column
 * @method     ChildUserQuery orderByDeletedDate($order = Criteria::ASC) Order by the deleted_date column
 * @method     ChildUserQuery orderByBlockedDate($order = Criteria::ASC) Order by the blocked_date column
 ...
 * @method     ChildUserQuery orderByDeletedFlag($order = Criteria::ASC) Order by the deleted_flag column
 * @method     ChildUserQuery orderByBlockedFlag($order = Criteria::ASC) Order by the blocked_flag column
 * @method     ChildUserQuery orderByLocaleId($order = Criteria::ASC) Order by the locale_id column
 * @method     ChildUserQuery orderByUserTypeId($order = Criteria::ASC) Order by the user_type_id column
 *
 * @method     ChildUserQuery groupById() Group by the id column
 * @method     ChildUserQuery groupByCreationDate() Group by the creation_date column
 * @method     ChildUserQuery groupByUpdatedDate() Group by the updated_date column
 * @method     ChildUserQuery groupByDeletedDate() Group by the deleted_date column
 * @method     ChildUserQuery groupByBlockedDate() Group by the blocked_date column
 ...
 * @method     ChildUserQuery groupByDeletedFlag() Group by the deleted_flag column
 * @method     ChildUserQuery groupByBlockedFlag() Group by the blocked_flag column
 * @method     ChildUserQuery groupByLocaleId() Group by the locale_id column
 * @method     ChildUserQuery groupByUserTypeId() Group by the user_type_id column
 *
 * @method     ChildUserQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildUserQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildUserQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildUserQuery leftJoinLocale($relationAlias = null) Adds a LEFT JOIN clause to the query using the Locale relation
 * @method     ChildUserQuery rightJoinLocale($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Locale relation
 * @method     ChildUserQuery innerJoinLocale($relationAlias = null) Adds a INNER JOIN clause to the query using the Locale relation
 *
 ...
 *
 * @method     ChildUserQuery leftJoinChannelUserEntry($relationAlias = null) Adds a LEFT JOIN clause to the query using the ChannelUserEntry relation
 * @method     ChildUserQuery rightJoinChannelUserEntry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ChannelUserEntry relation
 * @method     ChildUserQuery innerJoinChannelUserEntry($relationAlias = null) Adds a INNER JOIN clause to the query using the ChannelUserEntry relation
 *
 ...
 *
 * @method     ChildUserQuery leftJoinCommentUserEntry($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommentUserEntry relation
 * @method     ChildUserQuery rightJoinCommentUserEntry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommentUserEntry relation
 * @method     ChildUserQuery innerJoinCommentUserEntry($relationAlias = null) Adds a INNER JOIN clause to the query using the CommentUserEntry relation
 *
 ...
 *
 * @method     ChildUserQuery leftJoinThreadUserEntry($relationAlias = null) Adds a LEFT JOIN clause to the query using the ThreadUserEntry relation
 * @method     ChildUserQuery rightJoinThreadUserEntry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ThreadUserEntry relation
 * @method     ChildUserQuery innerJoinThreadUserEntry($relationAlias = null) Adds a INNER JOIN clause to the query using the ThreadUserEntry relation
 *
 * @method     \LocaleQuery|\UserTypeQuery|\ChannelUserEntryQuery|\CommentQuery|\CommentUserEntryQuery|\ThreadQuery|\ThreadUserEntryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByUpdatedDate(string $updated_date) Return the first ChildUser filtered by the updated_date column
 * @method     ChildUser findOneByDeletedDate(string $deleted_date) Return the first ChildUser filtered by the deleted_date column
 * @method     ChildUser findOneByBlockedDate(string $blocked_date) Return the first ChildUser filtered by the blocked_date column
 ...
 * @method     ChildUser findOneByDeletedFlag(boolean $deleted_flag) Return the first ChildUser filtered by the deleted_flag column
 * @method     ChildUser findOneByBlockedFlag(boolean $blocked_flag) Return the first ChildUser filtered by the blocked_flag column
 * @method     ChildUser findOneByLocaleId(string $locale_id) Return the first ChildUser filtered by the locale_id column
 * @method     ChildUser findOneByUserTypeId(string $user_type_id) Return the first ChildUser filtered by the user_type_id column *
 ...
 * @method     ChildUser requireOneByUpdatedDate(string $updated_date) Return the first ChildUser filtered by the updated_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByDeletedDate(string $deleted_date) Return the first ChildUser filtered by the deleted_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByBlockedDate(string $blocked_date) Return the first ChildUser filtered by the blocked_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByDeletedFlag(boolean $deleted_flag) Return the first ChildUser filtered by the deleted_flag column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByBlockedFlag(boolean $blocked_flag) Return the first ChildUser filtered by the blocked_flag column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByLocaleId(string $locale_id) Return the first ChildUser filtered by the locale_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByUserTypeId(string $user_type_id) Return the first ChildUser filtered by the user_type_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByUpdatedDate(string $updated_date) Return ChildUser objects filtered by the updated_date column
 * @method     ChildUser[]|ObjectCollection findByDeletedDate(string $deleted_date) Return ChildUser objects filtered by the deleted_date column
 * @method     ChildUser[]|ObjectCollection findByBlockedDate(string $blocked_date) Return ChildUser objects filtered by the blocked_date column
 ...
 * @method     ChildUser[]|ObjectCollection findByDeletedFlag(boolean $deleted_flag) Return ChildUser objects filtered by the deleted_flag column
 * @method     ChildUser[]|ObjectCollection findByBlockedFlag(boolean $blocked_flag) Return ChildUser objects filtered by the blocked_flag column
 * @method     ChildUser[]|ObjectCollection findByLocaleId(string $locale_id) Return ChildUser objects filtered by the locale_id column
 * @method     ChildUser[]|ObjectCollection findByUserTypeId(string $user_type_id) Return ChildUser objects filtered by the user_type_id column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, creation_date, updated_date, deleted_date, blocked_date, firstname, lastname, email, username, password, deleted_flag, blocked_flag, locale_id, user_type_id FROM user WHERE id = :p0';
        try {
    ...
    public function filterByUpdatedDate($updatedDate = null, $comparison = null)
    {
        if (is_array($updatedDate)) {
            ...
            if (isset($updatedDate['min'])) {
                $this->addUsingAlias(UserTableMap::COL_UPDATED_DATE, $updatedDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedDate['max'])) {
                $this->addUsingAlias(UserTableMap::COL_UPDATED_DATE, $updatedDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_UPDATED_DATE, $updatedDate, $comparison);
    }
    ...
    public function filterByDeletedDate($deletedDate = null, $comparison = null)
    {
        if (is_array($deletedDate)) {
            ...
            if (isset($deletedDate['min'])) {
                $this->addUsingAlias(UserTableMap::COL_DELETED_DATE, $deletedDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($deletedDate['max'])) {
                $this->addUsingAlias(UserTableMap::COL_DELETED_DATE, $deletedDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_DELETED_DATE, $deletedDate, $comparison);
    }

    /**
     * Filter the query on the blocked_date column
     *
     * Example usage:
     * <code>
     * $query->filterByBlockedDate('2011-03-14'); // WHERE blocked_date = '2011-03-14'
     * $query->filterByBlockedDate('now'); // WHERE blocked_date = '2011-03-14'
     * $query->filterByBlockedDate(array('max' => 'yesterday')); // WHERE blocked_date > '2011-03-13'
     * </code>
     *
     * @param     mixed $blockedDate The value to use as filter.
     *              Values can be integers (unix timestamps), DateTime objects, or strings.
     *              Empty strings are treated as NULL.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByBlockedDate($blockedDate = null, $comparison = null)
    {
        if (is_array($blockedDate)) {
            $useMinMax = false;
            if (isset($blockedDate['min'])) {
                $this->addUsingAlias(UserTableMap::COL_BLOCKED_DATE, $blockedDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($blockedDate['max'])) {
                $this->addUsingAlias(UserTableMap::COL_BLOCKED_DATE, $blockedDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_BLOCKED_DATE, $blockedDate, $comparison);
    }
    ...
    public function filterByDeletedFlag($deletedFlag = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_DELETED_FLAG, $deletedFlag, $comparison);
    }

    /**
     * Filter the query on the blocked_flag column
     *
     * Example usage:
     * <code>
     * $query->filterByBlockedFlag(true); // WHERE blocked_flag = true
     * $query->filterByBlockedFlag('yes'); // WHERE blocked_flag = true
     * </code>
     *
     * @param     boolean|string $blockedFlag The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByBlockedFlag($blockedFlag = null, $comparison = null)
    {
        if (is_string($blockedFlag)) {
            $blockedFlag = in_array(strtolower($blockedFlag), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_BLOCKED_FLAG, $blockedFlag, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByLocaleId('fooValue');   // WHERE locale_id = 'fooValue'
     * $query->filterByLocaleId('%fooValue%'); // WHERE locale_id LIKE '%fooValue%'
     * </code>
     *
     * @param     string $localeId The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
    ...
    public function filterByLocaleId($localeId = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($localeId)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $localeId)) {
                $localeId = str_replace('*', '%', $localeId);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(UserTableMap::COL_LOCALE_ID, $localeId, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByUserTypeId('fooValue');   // WHERE user_type_id = 'fooValue'
     * $query->filterByUserTypeId('%fooValue%'); // WHERE user_type_id LIKE '%fooValue%'
     * </code>
     *
     * @param     string $userTypeId The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
    ...
    public function filterByUserTypeId($userTypeId = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($userTypeId)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $userTypeId)) {
                $userTypeId = str_replace('*', '%', $userTypeId);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(UserTableMap::COL_USER_TYPE_ID, $userTypeId, $comparison);
    }

    /**
     * Filter the query by a related \Locale object
     *
     * @param \Locale|ObjectCollection $locale The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByLocale($locale, $comparison = null)
    {
        if ($locale instanceof \Locale) {
            return $this
                ->addUsingAlias(UserTableMap::COL_LOCALE_ID, $locale->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserTableMap::COL_LOCALE_ID, $locale->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByLocale() only accepts arguments of type \Locale or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \LocaleQuery A secondary query class using the current class as primary query
     */
    public function useLocaleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinLocale($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Locale', '\LocaleQuery');
    }
    ...
    public function filterByUserType($userType, $comparison = null)
    {
        if ($userType instanceof \UserType) {
            return $this
                ->addUsingAlias(UserTableMap::COL_USER_TYPE_ID, $userType->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserTableMap::COL_USER_TYPE_ID, $userType->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByChannelUserEntry($channelUserEntry, $comparison = null)
    {
        if ($channelUserEntry instanceof \ChannelUserEntry) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $channelUserEntry->getUserId(), $comparison);
    ...
    public function filterByCommentUserEntry($commentUserEntry, $comparison = null)
    {
        if ($commentUserEntry instanceof \CommentUserEntry) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $commentUserEntry->getUserId(), $comparison);
    ...
    public function filterByThread($thread, $comparison = null)
    {
        if ($thread instanceof \Thread) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $thread->getOwnerUserId(), $comparison);
    ...
    public function filterByThreadUserEntry($threadUserEntry, $comparison = null)
    {
        if ($threadUserEntry instanceof \ThreadUserEntry) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $threadUserEntry->getUserId(), $comparison);
