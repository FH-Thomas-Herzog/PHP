...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('index-template.html'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/index-template.html'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/index-template.html'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for index-template.html in the named namespace
        $namedSource = $loader->getSource('@named/index-template.html');
        $this->assertEquals("named path\n", $namedSource);

        // get index-template.html from the main namespace
