...
class DataManager extends BaseObject
{
    ...
    /**
     * returns the global defined block which represents the data.
     * @return array the loaded categories
     */
    ...
    /**
     * Gets the books by its related category id
     * @param integer $categoryId the related category id
     * @return array the books which have the category id set.
     */
